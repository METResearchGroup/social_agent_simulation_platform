...
export default function SignIn() {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-2 py-16 text-beige-600">
        <LoadingSpinner />
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center p-8">
      <div className="w-full max-w-md">
        <h1 className="mb-2 text-2xl font-semibold text-beige-900 text-center">
