...
erDiagram
  ...
  agent ||--o{ agent_generated_bios : "fk_agent_generated_bios_agent_id (agent_id)"
...
- `agent_generated_bios` `fk_agent_generated_bios_agent_id`: `agent_id` → `agent_id`
...
### Primary key (`agent_generated_bios`)

- Name: `pk_agent_generated_bios`
- Columns: `id`

### Foreign keys (`agent_generated_bios`)

- `fk_agent_generated_bios_agent_id`: `agent_id` → `agent(agent_id)`

### Indexes (`agent_generated_bios`)

- `idx_agent_generated_bios_agent_id_created_at`: `agent_id`, `created_at`
