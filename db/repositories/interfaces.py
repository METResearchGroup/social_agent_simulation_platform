...
class RunFollowEdgeRepository(ABC):
    """Abstract repository for immutable run-start follow-edge snapshots."""
    ...
    def write_run_follow_edges(
        ...
        """Write all run-follow-edge snapshot rows for a run."""
        raise NotImplementedError

    @abstractmethod
    def list_run_follow_edges(self, run_id: str) -> list[RunFollowEdgeSnapshot]:
        """List run-follow-edge snapshots ordered by follower and target ascending."""
        raise NotImplementedError
...
class AgentPostLikeRepository(ABC):
    ...
    def write_agent_post_likes(
        ...
        """Persist agent_post_likes rows (seed-state)."""
        raise NotImplementedError
    ...
    def list_likes_for_agent_post_ids(
        ...
        """List seed-state likes for the provided agent_post_ids."""
        raise NotImplementedError


class RunPostLikeRepository(ABC):
    """Abstract repository for immutable run-start like snapshots."""
    ...
    def write_run_post_likes(
        ...
        """Persist run_post_likes rows for a run."""
        raise NotImplementedError
...
class AgentFollowEdgeRepository(ABC):
    ...
    def count_edges_by_follower_agent_id(
        ...
        """Count follow edges for a follower."""
        raise NotImplementedError
    ...
    def count_edges_by_target_agent_id(
        ...
        """Count follow edges for a target."""
        raise NotImplementedError
    ...
    def delete_edge(
        ...
        """Delete one follow edge and return whether it existed."""
        raise NotImplementedError
