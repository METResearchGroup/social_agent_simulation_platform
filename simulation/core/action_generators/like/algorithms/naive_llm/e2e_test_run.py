...
def main() -> None:
    ...
    for i, candidates in enumerate([candidates_1, candidates_2, candidates_3], 1):
        ...
        assert generated_items, "Expected at least one generated like action"  # noqa: S101  # nosec B101
        expected_agent_id = canonical_agent_id(agent_handle)
        for item in generated_items:
            assert item.like.agent_id == expected_agent_id  # noqa: S101  # nosec B101
