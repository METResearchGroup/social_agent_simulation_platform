...
class TestRunMetricKeys:
    def test_post_run_with_metric_keys_returns_details_with_keys(
        ...
        fastapi_app.state.context.engine = EngineFactory.create_completed_run_engine(
    ...
    def test_post_run_without_metric_keys_uses_defaults(self, simulation_client):
