...
class TestSimulationAgents:
    def test_get_simulations_agents_returns_list(self, simulation_client, temp_db):
    ...
    def test_get_simulations_agents_matches_db_and_sorted(
        self, simulation_client, temp_db, agent_repo
    ):
    ...
    def test_get_simulations_agents_fields_present(self, simulation_client, temp_db):
    ...
    def test_post_simulations_agents_success(self, simulation_client, temp_db):
    ...
    def test_get_simulations_agents_pagination(
        self, simulation_client, temp_db, agent_repo
    ):
    ...
    def test_get_simulations_agents_query_too_long_returns_422(
        self, simulation_client, temp_db
    ):
    ...
    def test_get_simulations_agents_query_wildcards(
        self, simulation_client, temp_db, agent_repo
    ):
    ...
    def test_get_simulations_agents_query_like_metacharacters(
        ...
        expected_result = {
            "status_code": 200,
            "handles": ["@has_under_score.bsky.social"],
        }
        ...
        expected_result = {
            "status_code": 200,
            "handles": [r"@has\backslash.bsky.social"],
        }
    ...
    def test_get_simulations_agents_query_scrubbing(
        self, simulation_client, temp_db, agent_repo
    ):
