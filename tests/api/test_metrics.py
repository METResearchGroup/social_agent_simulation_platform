...
class TestMetrics:
    def test_get_metrics_returns_list(self, simulation_client):
    ...
    def test_get_metrics_includes_builtins(self, simulation_client):
    ...
    def test_get_metrics_ordering_deterministic(self, simulation_client):
    ...
    def test_get_metrics_schema_shape(self, simulation_client):
