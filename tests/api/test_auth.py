...
class TestAuth:
    def test_protected_route_without_token_returns_401(self, client_no_auth_override):
    ...
    def test_protected_route_with_invalid_token_returns_401(
        self, client_no_auth_override, monkeypatch
    ):
    ...
    def test_health_route_remains_public(self, client_no_auth_override):
    ...
    def test_disable_auth_in_production_raises_at_startup(self, monkeypatch):
