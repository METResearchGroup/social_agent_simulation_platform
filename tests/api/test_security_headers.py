...
class TestSecurityHeaders:
    ...
    def test_hsts_absent_when_disabled(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_hsts_present_when_enabled(self, monkeypatch: pytest.MonkeyPatch) -> None:
