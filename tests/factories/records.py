    ...
    def create(
        ...
        *,
        ...
        agent_id_value = (
            ...
            else canonical_agent_id(f"tests.agent_record.{fake.uuid4()}")
        )
        handle_value = (
    ...
    def create(
        ...
        *,
        ...
        agent_id_value = (
            agent_id
            if agent_id is not None
            else canonical_agent_id(f"tests.agent_bio.{fake.uuid4()}")
        )
        created_at_value = (
            created_at if created_at is not None else _timestamp_utc_compact()
        )
    ...
    def create(
        ...
        *,
        ...
        agent_id_value = (
            agent_id
            if agent_id is not None
            else canonical_agent_id(f"tests.user_agent_metadata.{fake.uuid4()}")
        )
        created_at_value = (
            created_at if created_at is not None else _timestamp_utc_compact()
        )
