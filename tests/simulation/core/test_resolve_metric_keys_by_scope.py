...
class TestResolveMetricKeysByScope:
    def test_resolve_metric_keys_by_scope_splits_correctly(self):
    ...
    def test_resolve_metric_keys_by_scope_turn_only(self):
    ...
    def test_resolve_metric_keys_by_scope_run_only(self):
    ...
    def test_resolve_metric_keys_by_scope_duplicate_keys_raises(self):
    ...
    def test_resolve_metric_keys_by_scope_unknown_key_raises(self):
    ...
    def test_registered_metric_keys_contains_all_builtins(self):
