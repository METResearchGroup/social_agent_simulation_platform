...
def _post(
    ...
    *,
    ...
    resolved_author_handle: str = author_handle or f"author-{uri}.bsky.social"
...
class TestRandomSimpleFollowPolicy:
    ...
    def test_respects_top_k_limit_when_probability_allows(self, monkeypatch):
    ...
    def test_deduplicates_author_candidates(self, monkeypatch):
    ...
    def test_excludes_self_from_follow_candidates(self, monkeypatch):
