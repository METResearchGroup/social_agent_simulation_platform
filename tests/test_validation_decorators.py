...
class TestValidationDecorators:
    def test_validate_inputs_rebinds_normalized_values(self) -> None:
    ...
    def test_validate_inputs_raises_on_invalid_values(self) -> None:
    ...
    def test_validate_inputs_supports_cross_field_validation(self) -> None:
    ...
    def test_validate_inputs_preserves_signature(self) -> None:
